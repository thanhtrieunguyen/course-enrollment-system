    ...
    <div class="nav-menu">
        <div class="container">
            <div class="nav-content">
                <nav class="main-nav">
                    <a href="/admin" class="nav-link {{ Request::is('admin') ? 'active' : '' }}">Trang Chủ</a>
                    <a href="/quanly-sinhvien"
                        class="nav-link {{ Request::is('quanly-sinhvien') ? 'active' : '' }}">Quản lý sinh viên</a>
                    <a href="/quanly-monhoc" class="nav-link {{ Request::is('quanly-monhoc') ? 'active' : '' }}">Quản lý
                        môn học</a>
                    <a href="/quanly-khoa" class="nav-link {{ Request::is('quanly-khoa') ? 'active' : '' }}">Quản lý
                        khoa</a>
                    <a href="/quanly-lop" class="nav-link {{ Request::is('quanly-lop') ? 'active' : '' }}">Quản lý
                        lớp</a>
                    <a href="/quanly-hocky" class="nav-link {{ Request::is('quanly-hocky') ? 'active' : '' }}">Quản lý
                        học kỳ</a>
                </nav>
